...
namespace Breath
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public void DisplayTextBoxContents()
        {
            ...
            if(DrunkLevel <= 225)
            {
                DrunkText = "Trace Amount Detected - Totally Sober!";
            ...
            if (DrunkLevel >= 300)
            {
                DrunkText = "Moderate Buzz! You should probably slow down to maintain professionalism!";
            ...
            if (DrunkLevel >= 400)
            {
                DrunkText = "Strong Buzz! Liquid Courage Engaged!";

            }

            if (DrunkLevel >= 500)
            {
                DrunkText = "Minor Drunk! or maybe just Belgian?";

            }

            if (DrunkLevel >= 600)
            {
                DrunkText = "Totally DRUNK!";

            }

            if (DrunkLevel >= 800)
            {
                DrunkText = "you are MASSIVLEY DRUNK and you need help!";

            }

            textPlaceHolder.Text = DrunkText;
            valuePlaceHolder.Text = res.ToString();
        }
